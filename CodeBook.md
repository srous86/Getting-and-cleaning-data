...
1 Start by downloading the file from Coursera and unzip the file
2 Set the working directory to the test file
3 Read test text files into tables
4 Bind the test tables by columns
...
5 Set the working directory to the train file
6 Read train text files into tables
7 Bind the train tables by columns
8 Bind each test and train tables by the rows for each portion of the tidy data set **subject, activity and features**

9 Set the working directory back to the UCI Har Dataset
10 Read the features names from the text file 
11 Add the names to features table variables
...
13 Label the variables in the subject and activity tables
14 Read the activity labels text file into a data table
15 Label the variable in the new activityLabels data table
...
16 Merge the **subject, activity and features** data tables the final data set
...
17 Using the Melt function reshape the final data set by the variable names **activityNum, activityName, subject, variable and value**
...
18 Reshape using the dcast function to return the data starting by the subject variable
